...
from PyQt5.QtWidgets import (QApplication, QMainWindow, QTreeWidget, QTreeWidgetItem, QVBoxLayout, QWidget, 
                             ...
                             QDialog, QTextEdit, QScrollBar, QSplitter,QSizePolicy)
...
class MiniMapWidget(QWidget):
    ...
    def paintEvent(self, event):
        ...
        for i in range(self.tree_widget.topLevelItemCount()):
            ...
            painter.drawText(minimap_rect, Qt.AlignCenter, item.text(0))  # 仅显示寄存器的名字
...
class RegisterViewer(QMainWindow):
    def __init__(self):
        ...
        # 将顶部的水平布局添加到主布局中，并设置大小策略
        self.top_layout.setSizePolicy(QSizePolicy.Expanding, QSizePolicy.Fixed)
